    ...
    <footer class="bg-dark py-4 py-md-5 text-light">
      <div class="container row g-0 mx-auto px-3 fs-7 ls-2
        ...
        <p>
          ...
          <small class="d-block mt-1">Nature &copy; 2021 copyright</small>
        </p>
        <ul class="list-unstyled d-flex justify-content-center m-0">
          <li class="fs-7">
            <a href="https://github.com/Evalin0316" target="_blank">
          ...
          <li class="fs-7">
            <a href="mailto:shepherdlord1119@gmail.com" target="_blank">
